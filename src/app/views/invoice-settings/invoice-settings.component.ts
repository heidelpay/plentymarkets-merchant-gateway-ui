...
@Component({
    ...
    template: require('./invoice-settings.component.html'),
    styles:   [require('./invoice-settings.component.scss')],
})
export class InvoiceSettingsComponent implements OnInit
{
    ...
    private service:InvoiceSettingsService;
    ...
    constructor(
        ...
        this.service = invoiceSettingsService;
    }
