...
@Component({
    selector: 'invoice-guaranteed-settings',
    template: require('./invoice-guaranteed-settings.component.html'),
    styles: [require('./invoice-guaranteed-settings.component.scss')],
})
export class InvoiceGuaranteedSettingsComponent implements OnInit {
    ...
    private service: InvoiceGuaranteedSettingsService;
    ...
    constructor(
        ...
        private invoiceGuaranteedSettingsService: InvoiceGuaranteedSettingsService
    ) {
