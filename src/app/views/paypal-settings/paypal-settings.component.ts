...
import { PaypalSettingsService } from './paypal-settings.service';

@Component({
    selector: 'paypal-settings',
    template: require('./paypal-settings.component.html'),
    styles:   [require('./paypal-settings.component.scss')],
})
export class PaypalSettingsComponent implements OnInit
{
    ...
    private service:PaypalSettingsService;
    ...
    constructor(
        ...
        this.service = paypalSettingsService;
    }
