...
@Injectable()
export class SepaDirectDebitGuaranteedSettingsService extends TerraBaseService
{
    ...
    public getBasicSettings():Observable<any>
    {
        ...
        let url:string = this.url + '/rest/' + localConfig.pluginName + '/sepa-direct-debit-guaranteed-settings';
