...
import { IdealSettingsService } from './ideal-settings.service';

@Component({
    selector: 'ideal-settings',
    template: require('./ideal-settings.component.html'),
    styles:   [require('./ideal-settings.component.scss')],
})
export class IdealSettingsComponent implements OnInit
{
    ...
    private service:IdealSettingsService;
    ...
    constructor(
        ...
        private idealSettingsService:IdealSettingsService
    ) {
        this.alert = TerraAlertComponent.getInstance();
        this.service = idealSettingsService;
    }
